package com.findit.battle.iap.util;
...
public class IabHelper {
    ...
    String mAsyncOperation = GameView.CHARACTER_AI;
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        this.mServiceConn = new ServiceConnection() { // from class: com.findit.battle.iap.util.IabHelper.1
    ...
    public void launchPurchaseFlow(Activity act, String sku, int requestCode, OnIabPurchaseFinishedListener listener) {
        launchPurchaseFlow(act, sku, requestCode, listener, GameView.CHARACTER_AI);
    }
    ...
    public void launchSubscriptionPurchaseFlow(Activity act, String sku, int requestCode, OnIabPurchaseFinishedListener listener) {
        launchSubscriptionPurchaseFlow(act, sku, requestCode, listener, GameView.CHARACTER_AI);
    }
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:18:0x00b6 -> B:26:0x002f). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:19:0x00b8 -> B:26:0x002f). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:24:0x0147 -> B:26:0x002f). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:25:0x0149 -> B:26:0x002f). Please report as a decompilation issue!!! */
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == -1 && responseCode == 0) {
            ...
            IabResult result6 = new IabResult(-1005, "User canceled.");
            if (this.mPurchaseListener != null) {
            ...
            IabResult result7 = new IabResult(-1006, "Unknown purchase response.");
            if (this.mPurchaseListener != null) {
    ...
    public void queryInventoryAsync(final boolean querySkuDetails, final List<String> moreSkus, final QueryInventoryFinishedListener listener) {
        ...
        new Thread(new Runnable() { // from class: com.findit.battle.iap.util.IabHelper.2
            ...
            public void run() {
                ...
                if (!IabHelper.this.mDisposed && listener != null) {
                    ...
                    handler2.post(new Runnable() { // from class: com.findit.battle.iap.util.IabHelper.2.1
                        @Override // java.lang.Runnable
                        public void run() {
    ...
    void consume(Purchase itemInfo) throws IabException {
        ...
        try {
            ...
            if (token == null || token.equals(GameView.CHARACTER_AI)) {
    ...
    public static String getResponseDesc(int code) {
        String[] iab_msgs = "0:OK/1:User Canceled/2:Unknown/3:Billing Unavailable/4:Item unavailable/5:Developer Error/6:Error/7:Item Already Owned/8:Item not owned".split(Objects.Animation.DEVIDER_DATA);
        String[] iabhelper_msgs = "0:OK/-1001:Remote exception during initialization/-1002:Bad response received/-1003:Purchase signature verification failed/-1004:Send intent failed/-1005:User cancelled/-1006:Unknown purchase response/-1007:Missing token/-1008:Unknown error/-1009:Subscriptions not available/-1010:Invalid consumption attempt".split(Objects.Animation.DEVIDER_DATA);
        if (code <= -1000) {
            int index = (-1000) - code;
            return (index < 0 || index >= iabhelper_msgs.length) ? String.valueOf(String.valueOf(code)) + ":Unknown IAB Helper Error" : iabhelper_msgs[index];
        }
    ...
    void flagEndAsync() {
        ...
        this.mAsyncOperation = GameView.CHARACTER_AI;
    ...
    void consumeAsyncInternal(final List<Purchase> purchases, final OnConsumeFinishedListener singleListener, final OnConsumeMultiFinishedListener multiListener) {
        ...
        new Thread(new Runnable() { // from class: com.findit.battle.iap.util.IabHelper.3
            @Override // java.lang.Runnable
            public void run() {
                ...
                if (!IabHelper.this.mDisposed && singleListener != null) {
                    ...
                    handler2.post(new Runnable() { // from class: com.findit.battle.iap.util.IabHelper.3.1
                        @Override // java.lang.Runnable
                        public void run() {
                ...
                if (!IabHelper.this.mDisposed && multiListener != null) {
                    ...
                    handler3.post(new Runnable() { // from class: com.findit.battle.iap.util.IabHelper.3.2
                        @Override // java.lang.Runnable
                        public void run() {
