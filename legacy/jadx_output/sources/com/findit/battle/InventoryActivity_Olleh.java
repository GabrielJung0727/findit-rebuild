...
public class InventoryActivity_Olleh extends KTInAppActivity implements SamsungIapHelper.OnInitIapListener {
    private static final int ANIMAION_DOWN = 0;
    private static final int ANIMAION_SCALE = 2;
    private static final int ANIMAION_UP = 1;
    private static final String APP_ID = "100000100952";
    ...
    OnInAppListener mInAPInformationListener = new OnInAppListener() { // from class: com.findit.battle.InventoryActivity_Olleh.1
        public void OnResultPurchase(String tr_id) {
            LOG.verbose(">> OnResultPurchase()");
            InventoryActivity_Olleh.this.applyPurchaseItem((Items.Item) InventoryActivity_Olleh.this.mPurchaseItemMap.get(tr_id));
            Toast.makeText(InventoryActivity_Olleh.this.getApplicationContext(), "결제 완료", 0).show();
        }
        ...
        public void OnError(String errorCode, String msg) {
            LOG.verbose(">> OnError()");
            Toast.makeText(InventoryActivity_Olleh.this.getApplicationContext(), msg, 0).show();
        }

        @Override // com.kt.olleh.inapp.OnInAppListener
        public void OnResultOLDAPI(String code, String message) {
            LOG.verbose(">> OnResultOLDAPI()");
            Toast.makeText(InventoryActivity_Olleh.this.getApplicationContext(), String.valueOf(code) + " : " + message, 0).show();
        }
    ...
    public Handler mBuyResultHandler = new Handler() { // from class: com.findit.battle.InventoryActivity_Olleh.2
        @Override // android.os.Handler
        public void handleMessage(Message msg) {
            String data;
            LOG.verbose(">> mBuyResultHandler::handleMessage()");
            InventoryActivity_Olleh.this.mCommonDialog.cancelProgressDlg();
            boolean value = msg.getData().getBoolean("result");
            if (!value) {
                InventoryActivity_Olleh.this.mCommonDialog.showNoticeDlg(R.string.notice_msg_buyfail);
                return;
            }
            JSONObject jsonobject = InventoryActivity_Olleh.this.mConnectNetwork.getJSONObject();
            if (jsonobject != null) {
                try {
                    ...
                    if (result.equals("000") && (data = msg.getData().getString(ConnectNetwork.HANDLER_MSG_KEY_TAG_STRING)) != null) {
                        ...
                        Items.Item typeitem = InventoryActivity_Olleh.this.mItems.mTypeItem[type].mSubItem[subtype];
                        ImageView imageview = (ImageView) InventoryActivity_Olleh.this.mShopItemSlotsLayout[subtype].getChildAt(0);
                        imageview.startAnimation(InventoryActivity_Olleh.this.mAnimation[2]);
                        Items.Item item = InventoryActivity_Olleh.this.mItems.checkOverlap(type, subtype);
                        if (item == null) {
                            Items.Item item2 = InventoryActivity_Olleh.this.mItems.createItem(type, subtype);
                            InventoryActivity_Olleh.this.setItemSlot(item2);
                            InventoryActivity_Olleh.this.calculateCoin(item2.mPrice);
                            return;
                        }
                        ...
                        if (item.mSet) {
                            InventoryActivity_Olleh.this.setItemSetSlot(type, item);
                        } else if (item.mSlotnum > -1) {
                            InventoryActivity_Olleh.this.setItemSlot(item.mSlotnum, item);
                        }
                        InventoryActivity_Olleh.this.calculateCoin(item.mPrice);
                    }
                } catch (JSONException e) {
                    InventoryActivity_Olleh.this.mCommonDialog.showNoticeDlg(InventoryActivity_Olleh.this.getApplicationContext(), R.string.notice_msg_buyfail, "[1]");
                }
            }
        }
    };
    public Handler mLearnResultHandler = new Handler() { // from class: com.findit.battle.InventoryActivity_Olleh.3
        @Override // android.os.Handler
        public void handleMessage(Message msg) {
            String data;
            ...
            if (jsonobject != null) {
                try {
                    ...
                    if (result.equals("000") && (data = msg.getData().getString(ConnectNetwork.HANDLER_MSG_KEY_TAG_STRING)) != null) {
                        ...
                        ImageView imageview = (ImageView) InventoryActivity_Olleh.this.mSkillSlotsLayout[index].getChildAt(0);
                        imageview.setImageDrawable(null);
                        imageview.startAnimation(InventoryActivity_Olleh.this.mAnimation[2]);
                        InventoryActivity_Olleh.this.mSkills.mSkill[index].mBuy = true;
                        InventoryActivity_Olleh.this.mSkills.mSkill[index].mSetNum = -1;
                        InventoryActivity_Olleh.this.mSkills.mSkill[index].mNum = InventoryActivity_Olleh.this.mSkills.getEmptySlotNum();
                        InventoryActivity_Olleh.this.mPoint -= InventoryActivity_Olleh.this.mSkills.mSkill[index].mPoint;
                        InventoryActivity_Olleh.this.mSkillPointNumTextView.setText(new StringBuilder().append(InventoryActivity_Olleh.this.mPoint).toString());
                        InventoryActivity_Olleh.this.setSkillSlot(index);
                    }
                } catch (JSONException e) {
                    InventoryActivity_Olleh.this.mCommonDialog.showNoticeDlg(InventoryActivity_Olleh.this.getApplicationContext(), R.string.notice_msg_buyfail, "[1]");
                }
    ...
    public Handler mCoinResultHandler = new Handler() { // from class: com.findit.battle.InventoryActivity_Olleh.4
        @Override // android.os.Handler
        public void handleMessage(Message msg) {
            String data;
            ...
            if (value) {
                ...
                try {
                    String result = jsonobject.getString("result");
                    if (result == null) {
                        InventoryActivity_Olleh.this.mCommonDialog.showNoticeDlg(InventoryActivity_Olleh.this, R.string.notice_msg_networkfail, "[0]");
                    } else if (result.equals("000") && (data = msg.getData().getString(ConnectNetwork.HANDLER_MSG_KEY_TAG_STRING)) != null) {
                        InventoryActivity_Olleh.this.calculateCoin(Integer.parseInt(data));
                    }
                } catch (JSONException e) {
                    InventoryActivity_Olleh.this.mCommonDialog.showNoticeDlg(InventoryActivity_Olleh.this.getApplicationContext(), R.string.notice_msg_networkfail, "[1]");
                }
            }
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] keys = {"000001005358", "000001005359", "000001005360", "000001005361"};
    ...
    private void setTab() {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.5
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
                InventoryActivity_Olleh.this.setItemTab();
            }
        });
        this.mItemTabButton = button;
        Button button2 = (Button) findViewById(R.id.ShopTabButton);
        button2.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.6
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
                InventoryActivity_Olleh.this.setShopTab();
            }
        });
        this.mShopTabButton = button2;
        Button button3 = (Button) findViewById(R.id.SkillTabButton);
        button3.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.7
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
                InventoryActivity_Olleh.this.setSkillTab();
            }
        });
    ...
    private void createItemSlots(float widthrate, float heightrate) {
        ...
        slotscrollview.setOnTouchListener(new View.OnTouchListener() { // from class: com.findit.battle.InventoryActivity_Olleh.8
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    case 1:
                        int index2 = InventoryActivity_Olleh.this.mMoveItemView.mIndex;
                        if (index2 > -1) {
                            InventoryActivity_Olleh.this.mMoveItemView.move(touchx, touchy, InventoryActivity_Olleh.this.mSlotWindowX, InventoryActivity_Olleh.this.mSlotWindowY);
                            InventoryActivity_Olleh.this.setSlotImageAlpha(index2, false);
                            if (!InventoryActivity_Olleh.this.changeSetItemSlots(touchx, touchy, InventoryActivity_Olleh.this.mSlotWindowX, InventoryActivity_Olleh.this.mSlotWindowY, index2)) {
                                if (touchx >= 0) {
                                    InventoryActivity_Olleh.this.changeItemSlots(touchx, touchy, 0, 0, index2);
                                } else {
                                    InventoryActivity_Olleh.this.setDeleteItem(index2);
                                    InventoryActivity_Olleh.this.mDeleteItemDlg.show();
                                }
                            }
                        }
                        InventoryActivity_Olleh.this.mMoveItemView.fadeView();
                        InventoryActivity_Olleh.this.setFirstTouch(-1, -1, 0, 0);
                        return true;
                    case 2:
                        if (InventoryActivity_Olleh.this.isActionMove(touchx, touchy, InventoryActivity_Olleh.this.mSlotWindowX, InventoryActivity_Olleh.this.mSlotWindowY) && (index = InventoryActivity_Olleh.this.mMoveItemView.mIndex) > -1) {
                            InventoryActivity_Olleh.this.mMoveItemView.move(touchx, touchy, InventoryActivity_Olleh.this.mSlotWindowX, InventoryActivity_Olleh.this.mSlotWindowY);
                            InventoryActivity_Olleh.this.mMoveItemView.appearView();
                            InventoryActivity_Olleh.this.setSlotImageAlpha(index, true);
                        }
                        return true;
                    default:
                        return true;
        ...
        for (int i3 = 0; i3 < 1; i3++) {
            for (int j = 0; j < 5; j++) {
                ...
                for (int z = 0; z < 3; z++) {
                    ...
                    slotlayout.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.9
                        @Override // android.view.View.OnClickListener
                        public void onClick(View v) {
                            ...
                            if (InventoryActivity_Olleh.this.mSlotNum != slotnum) {
                                layout2.setBackgroundResource(R.drawable.slot_s);
                                InventoryActivity_Olleh.this.mSlotsLayout[InventoryActivity_Olleh.this.mSlotNum].setBackgroundResource(R.drawable.slot_n);
                                InventoryActivity_Olleh.this.mSlotNum = slotnum;
                                InventoryActivity_Olleh.this.setItemText();
                            }
                        }
                    });
                    slotlayout.setOnTouchListener(new View.OnTouchListener() { // from class: com.findit.battle.InventoryActivity_Olleh.10
                        @Override // android.view.View.OnTouchListener
                        public boolean onTouch(View v, MotionEvent event) {
                            ...
                            switch (event.getAction()) {
                                case 0:
                                    InventoryActivity_Olleh.this.setMoveItemImage(InventoryActivity_Olleh.this.mItems.getIndex(slotnum));
                                    InventoryActivity_Olleh.this.setFirstTouch(touchx, touchy, InventoryActivity_Olleh.this.mSlotWindowX + InventoryActivity_Olleh.this.mMoveItemView.getTileStandardX(slotnum), InventoryActivity_Olleh.this.mSlotWindowY + InventoryActivity_Olleh.this.mMoveItemView.getTileStandardY(slotnum));
                                    break;
                                case 1:
                                    int index = InventoryActivity_Olleh.this.mMoveItemView.mIndex;
                                    if (index > -1) {
                                        int x = InventoryActivity_Olleh.this.mSlotWindowX + InventoryActivity_Olleh.this.mMoveItemView.getTileStandardX(slotnum);
                                        int y = InventoryActivity_Olleh.this.mSlotWindowY + InventoryActivity_Olleh.this.mMoveItemView.getTileStandardY(slotnum);
                                        InventoryActivity_Olleh.this.mMoveItemView.move(touchx, touchy, x, y);
                                        InventoryActivity_Olleh.this.setSlotImageAlpha(index, false);
                                        if (!InventoryActivity_Olleh.this.changeSetItemSlots(touchx, touchy, x, y, index)) {
                                            InventoryActivity_Olleh.this.changeItemSlots(touchx, touchy, InventoryActivity_Olleh.this.mMoveItemView.getTileStandardX(slotnum), InventoryActivity_Olleh.this.mMoveItemView.getTileStandardY(slotnum), index);
                                        }
                                    }
                                    InventoryActivity_Olleh.this.mMoveItemView.fadeView();
                                    InventoryActivity_Olleh.this.setFirstTouch(-1, -1, 0, 0);
                                    break;
                                case 2:
                                    if (InventoryActivity_Olleh.this.isActionMove(touchx, touchy, InventoryActivity_Olleh.this.mSlotWindowX + InventoryActivity_Olleh.this.mMoveItemView.getTileStandardX(slotnum), InventoryActivity_Olleh.this.mSlotWindowY + InventoryActivity_Olleh.this.mMoveItemView.getTileStandardY(slotnum))) {
                                        int index2 = InventoryActivity_Olleh.this.mMoveItemView.mIndex;
                                        if (index2 > -1) {
                                            InventoryActivity_Olleh.this.mMoveItemView.move(touchx, touchy, InventoryActivity_Olleh.this.mSlotWindowX + InventoryActivity_Olleh.this.mMoveItemView.getTileStandardX(slotnum), InventoryActivity_Olleh.this.mSlotWindowY + InventoryActivity_Olleh.this.mMoveItemView.getTileStandardY(slotnum));
                                            InventoryActivity_Olleh.this.mMoveItemView.appearView();
                                            InventoryActivity_Olleh.this.setSlotImageAlpha(index2, true);
                                        }
                                        InventoryActivity_Olleh.this.setFirstTouch(-1, -1, 0, 0);
                                    }
                                    break;
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.11
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
                LOG.verbose(">> SlotPreButton::setOnClickListener()");
                InventoryActivity_Olleh.this.setItemSlotWindowLocation(InventoryActivity_Olleh.this.mSlotWindowNum - 1);
            }
        });
        Button button2 = (Button) findViewById(R.id.SlotNextButton);
        button2.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.12
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
    ...
    private void createShopSlots(float widthrate, float heightrate) {
        ...
        for (int i2 = 0; i2 < 1; i2++) {
            for (int j = 0; j < 3; j++) {
                ...
                for (int z = 0; z < 2; z++) {
                    ...
                    slotlayout.setTag(new StringBuilder().append(num).toString());
                    slotlayout.setBackgroundResource(R.drawable.slot_n);
                    slotlayout.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.13
                        @Override // android.view.View.OnClickListener
                        public void onClick(View v) {
                            LOG.verbose(">> slotlayout::onClick()");
                            int slotnum = Integer.parseInt(v.getTag().toString());
                            InventoryActivity_Olleh.this.mShopSlotsLayout[0].setVisibility(4);
                            InventoryActivity_Olleh.this.mShopSlotsLayout[1].setVisibility(0);
                            InventoryActivity_Olleh.this.mShopSlotsLayout[0].startAnimation(InventoryActivity_Olleh.this.mAnimation[0]);
                            InventoryActivity_Olleh.this.mShopSlotsLayout[1].startAnimation(InventoryActivity_Olleh.this.mAnimation[1]);
                            int totalnum = InventoryActivity_Olleh.this.mItems.mTypeItem[InventoryActivity_Olleh.this.mShopItemTypeSlotNum].mSubItemTotalnum;
                            for (int i3 = 0; i3 < totalnum; i3++) {
                                InventoryActivity_Olleh.this.clearShopSlot(i3);
                            }
                            InventoryActivity_Olleh.this.mShopExplainTextView.setText(GameView.CHARACTER_AI);
                            int totalnum2 = InventoryActivity_Olleh.this.mItems.mTypeItem[slotnum].mSubItemTotalnum;
                            for (int i4 = 0; i4 < totalnum2; i4++) {
                                InventoryActivity_Olleh.this.setShopSlot(slotnum, i4);
                            }
                            InventoryActivity_Olleh.this.playSound(0);
                            InventoryActivity_Olleh.this.mShopItemTypeSlotNum = slotnum;
                            InventoryActivity_Olleh.this.selectShopItemSlot(InventoryActivity_Olleh.this.mShopItemSlotsLayout[0], 0);
                        }
                    });
                    slotlayout.setOnTouchListener(new View.OnTouchListener() { // from class: com.findit.battle.InventoryActivity_Olleh.14
                        @Override // android.view.View.OnTouchListener
                        public boolean onTouch(View v, MotionEvent event) {
                            LOG.verbose(">> slotlayout::onTouch()");
                            switch (event.getAction()) {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.15
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                LOG.verbose(">> ShopBreakdownButton::onClick()");
                InventoryActivity_Olleh.this.mBuyListTitleTextView.setText(String.valueOf(InventoryActivity_Olleh.this.mUserId) + InventoryActivity_Olleh.this.mBuyListTitleText);
                InventoryActivity_Olleh.this.fillBuyListData();
                InventoryActivity_Olleh.this.mBuyListDlg.show();
            }
        });
        ...
        for (int i3 = 0; i3 < 1; i3++) {
            for (int j2 = 0; j2 < 5; j2++) {
                ...
                for (int z2 = 0; z2 < 3; z2++) {
                    ...
                    slotlayout2.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.16
                        @Override // android.view.View.OnClickListener
                        public void onClick(View v) {
                            LOG.verbose(">> slotlayout::onClick()");
                            RelativeLayout layout = (RelativeLayout) v;
                            int slotnum = Integer.parseInt(layout.getTag().toString());
                            InventoryActivity_Olleh.this.selectShopItemSlot(layout, slotnum);
                        }
                    });
        ...
        button2.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.17
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                Items.Item item;
                LOG.verbose(">> ShopBuyButton::onClick()");
                Items items = InventoryActivity_Olleh.this.mItems;
                int type = InventoryActivity_Olleh.this.mShopItemTypeSlotNum;
                int suptype = InventoryActivity_Olleh.this.mShopItemSlotNum;
                if (type > -1 && suptype > -1 && items.mTypeItem[type] != null && items.mTypeItem[type].mSubItem[suptype] != null && (item = items.mTypeItem[type].mSubItem[suptype]) != null) {
                    if (item.mMoney > 0) {
                        InventoryActivity_Olleh.this.setBuyItem(type, suptype, false);
                        InventoryActivity_Olleh.this.mBuyItemDlg.show();
                    } else {
                        InventoryActivity_Olleh.this.setBuyItem(type, suptype, true);
                        InventoryActivity_Olleh.this.mBuyItemDlg.show();
                    }
                }
            }
        ...
        button3.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.18
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                LOG.verbose(">> ShopBackButton::onClick()");
                InventoryActivity_Olleh.this.mShopSlotsLayout[0].setVisibility(0);
                InventoryActivity_Olleh.this.mShopSlotsLayout[1].setVisibility(4);
                InventoryActivity_Olleh.this.mShopSlotsLayout[0].startAnimation(InventoryActivity_Olleh.this.mAnimation[1]);
                InventoryActivity_Olleh.this.mShopSlotsLayout[1].startAnimation(InventoryActivity_Olleh.this.mAnimation[0]);
                InventoryActivity_Olleh.this.playSound(0);
            }
        });
        Button button4 = (Button) findViewById(R.id.ShopSlotPreButton);
        button4.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.19
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
                LOG.verbose(">> ShopSlotPreButton::onClick()");
                InventoryActivity_Olleh.this.setShopItemSlotWindowLocation(InventoryActivity_Olleh.this.mShopItemSlotWindowNum - 1);
            }
        });
        Button button5 = (Button) findViewById(R.id.ShopSlotNextButton);
        button5.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.20
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
    ...
    private void createSkillSlots(float widthrate, float heightrate) {
        ...
        for (int i2 = 0; i2 < 1; i2++) {
            for (int j = 0; j < 5; j++) {
                ...
                for (int z = 0; z < 3; z++) {
                    ...
                    slotlayout.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.21
                        @Override // android.view.View.OnClickListener
                        public void onClick(View v) {
                            LOG.verbose(">> slotlayout::onClick()");
                            RelativeLayout layout = (RelativeLayout) v;
                            int slotnum = Integer.parseInt(layout.getTag().toString());
                            if (InventoryActivity_Olleh.this.mSkillSlotNum != slotnum) {
                                layout.setBackgroundResource(R.drawable.slot_s);
                                InventoryActivity_Olleh.this.mSkillSlotsLayout[InventoryActivity_Olleh.this.mSkillSlotNum].setBackgroundResource(R.drawable.slot_n);
                                InventoryActivity_Olleh.this.mSkillSlotNum = slotnum;
                                InventoryActivity_Olleh.this.setSkillText();
                            }
                        }
                    });
                    ImageView imageview = new ImageView(this);
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.22
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
                LOG.verbose(">> SkillSlotPreButton::onClick()");
                InventoryActivity_Olleh.this.setSkillSlotWindowLocation(InventoryActivity_Olleh.this.mSkillSlotWindowNum - 1);
            }
        });
        Button button2 = (Button) findViewById(R.id.SkillSlotNextButton);
        button2.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.23
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
        ...
        button3.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.24
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
                Objects.Skills.Skill skill;
                LOG.verbose(">> SkillLearnButton::onClick()");
                int index = InventoryActivity_Olleh.this.mSkillSlotNum;
                if (index > -1 && (skill = InventoryActivity_Olleh.this.mSkills.mSkill[index]) != null) {
                    if (skill.mBuy) {
                        InventoryActivity_Olleh.this.mCommonDialog.showNoticeDlg(R.string.alreadylearn);
                    } else {
                        InventoryActivity_Olleh.this.setLearnSkill(index);
                        InventoryActivity_Olleh.this.mLearnSkillDlg.show();
                    }
                }
            }
        });
    ...
    class MoveView {
        ...
        public void setImage(int id) {
            ...
            BitmapDrawable img = new BitmapDrawable(InventoryActivity_Olleh.this.getResources().openRawResource(id));
    ...
    private void createDeleteItemDlg() {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.25
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
                int index;
                int slotnum;
                String tag = InventoryActivity_Olleh.this.mDeleteItemImageView.getTag().toString();
                if (tag != null && (index = Integer.parseInt(tag)) > -1 && index < InventoryActivity_Olleh.this.mItems.mItemTotalnum && (slotnum = InventoryActivity_Olleh.this.mItems.mItem[index].mSlotnum) > -1) {
                    InventoryActivity_Olleh.this.setItemSlot(slotnum, -1);
                    InventoryActivity_Olleh.this.mItems.destroyItem(index);
                }
                InventoryActivity_Olleh.this.mDeleteItemDlg.cancel();
            }
        });
        Button button2 = (Button) dialog.findViewById(R.id.NoButton);
        button2.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.26
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
                InventoryActivity_Olleh.this.mDeleteItemDlg.cancel();
            }
    ...
    private void createBuyItemDlg() {
        ...
        Button button = (Button) dialog.findViewById(R.id.YesButton);
        button.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.27
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
                LOG.verbose(">> YesButton::onClick()");
                String tag = InventoryActivity_Olleh.this.mBuyItemImageView.getTag().toString();
                if (tag != null) {
                    ...
                    if (typeitem.mMoney > 0) {
                        InventoryActivity_Olleh.this.purchaseItem(typeitem);
                    } else if (typeitem.mPrice > InventoryActivity_Olleh.this.mCoin) {
                        InventoryActivity_Olleh.this.mCommonDialog.showNoticeDlg(R.string.lackcoin);
                    } else {
                        ImageView imageview = (ImageView) InventoryActivity_Olleh.this.mShopItemSlotsLayout[subtype].getChildAt(0);
                        imageview.startAnimation(InventoryActivity_Olleh.this.mAnimation[2]);
                        Items.Item item = InventoryActivity_Olleh.this.mItems.checkOverlap(type, subtype);
                        if (item == null) {
                            if (type == 5) {
                                if (InventoryActivity_Olleh.this.mSkills.mSetSkillActiveIndexTable[typeitem.mPower]) {
                                    InventoryActivity_Olleh.this.mCommonDialog.showNoticeDlg(R.string.alreadybuy);
                                } else {
                                    InventoryActivity_Olleh.this.mSkills.mSetSkillActiveIndexTable[typeitem.mPower] = true;
                                    InventoryActivity_Olleh.this.sendSpendCoin(typeitem.mPrice);
                                }
                            } else {
                                InventoryActivity_Olleh.this.sendBuyItem(typeitem);
                            }
                ...
                InventoryActivity_Olleh.this.mBuyItemDlg.cancel();
            }
        });
        Button button2 = (Button) dialog.findViewById(R.id.NoButton);
        button2.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.28
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
    ...
    private void createLearnSkillDlg() {
        ...
        Button button = (Button) dialog.findViewById(R.id.YesButton);
        button.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.29
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
                LOG.verbose(">> YesButton::onClick()");
                String tag = InventoryActivity_Olleh.this.mLearnSkillImageView.getTag().toString();
                if (tag != null) {
                    int index = Integer.parseInt(tag);
                    if (InventoryActivity_Olleh.this.mPoint < InventoryActivity_Olleh.this.mSkills.mSkill[index].mPoint) {
                        InventoryActivity_Olleh.this.mCommonDialog.showNoticeDlg(R.string.lackpoint);
                    } else {
                        InventoryActivity_Olleh.this.sendLearnSkill(index);
                    }
                }
                InventoryActivity_Olleh.this.mLearnSkillDlg.cancel();
            }
        });
        Button button2 = (Button) dialog.findViewById(R.id.NoButton);
        button2.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.30
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
                LOG.verbose(">> NoButton::onClick()");
                InventoryActivity_Olleh.this.mLearnSkillDlg.cancel();
    ...
    private void createBuyListDlg() {
        ...
        imagebutton.setOnClickListener(new View.OnClickListener() { // from class: com.findit.battle.InventoryActivity_Olleh.31
            @Override // android.view.View.OnClickListener
            public void onClick(View arg0) {
                InventoryActivity_Olleh.this.mBuyListDlg.cancel();
            }
        });
    ...
    public class ActionRunnable implements Runnable {
        ...
        public void run() {
            ...
            InventoryActivity_Olleh.this.mSlotsScrollView.smoothScrollTo(this.mX, 0);
        }
    }
        ...
        switch (requestCode) {
            case 1:
                if (data != null) {
                    ...
                    String itemId = GameView.CHARACTER_AI;
                    int statusCode = 1;
                    if (extras != null) {
                        String thirdPartyName = extras.getString(SamsungIapHelper.KEY_NAME_THIRD_PARTY_NAME);
                        ...
                        LOG.info("3rdParty Name : " + thirdPartyName + "\nItemId        : " + itemId + "\nStatusCode    : " + statusCode + "\nerrorString   : " + errorString);
                    } else {
                        ...
                        errorString = GameView.CHARACTER_AI;
                    }
                    if (-1 == resultCode) {
                        if (statusCode == 0) {
                            PurchaseVO purchaseVO = new PurchaseVO(extras.getString(SamsungIapHelper.KEY_NAME_RESULT_OBJECT));
                            this.mSamsungIapHelper.verifyPurchaseResult(this, purchaseVO);
                            applyPurchaseItem(this.mPurchaseItemMap.get(itemId));
                        } else {
                            this.mSamsungIapHelper.showIapDialog(this, getString(R.string.dlg_title_payment_error), errorString, true, null);
                        }
    ...
    private void intiatieInAppPurchases() {
        LOG.verbose(">> intiatieInAppPurchases()");
    ...
    public void bindIapService() {
        LOG.verbose(">> bindIapService()");
        this.mSamsungIapHelper.bindIapService(new SamsungIapHelper.OnIapBindListener() { // from class: com.findit.battle.InventoryActivity_Olleh.32
            @Override // com.sec.android.iap.sample.helper.SamsungIapHelper.OnIapBindListener
            public void onBindIapFinished(int result) {
                LOG.verbose(">> OnIapBindListener::onBindIapFinished()");
                if (result == 0) {
                    InventoryActivity_Olleh.this.mSamsungIapHelper.safeInitIap(InventoryActivity_Olleh.this);
                } else {
                    InventoryActivity_Olleh.this.mSamsungIapHelper.dismissProgressDialog();
                    InventoryActivity_Olleh.this.mSamsungIapHelper.showIapDialog(InventoryActivity_Olleh.this, InventoryActivity_Olleh.this.getString(R.string.in_app_purchase), InventoryActivity_Olleh.this.getString(R.string.msg_iap_service_bind_failed), true, null);
                }
            }
        });
    }
    ...
    public void onSucceedInitIap() {
        LOG.verbose(">> onSucceedInitIap()");
        this.mSamsungIapHelper.dismissProgressDialog();
        this.mSamsungIapHelper.startPurchase(this, 1, "100000100952", this.mPurchaseId);
    }
